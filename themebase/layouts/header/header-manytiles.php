<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header manytilesheader" role="banner">
  ...
  <div class="testingdiv">
    ...
    <?php get_template_part( 'sidebars/sidebar-manytilessearch' ); ?>
    <?php// get_sidebar( 'manytilessearch' ); ?>
    
    <nav id="site-navigation" class="main-navigation manytilesnav" role="navigation">
